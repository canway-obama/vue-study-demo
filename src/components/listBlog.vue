<template>
    <div>
        ...
        <el-table 
            ...
            <el-table-column prop="when_created" label="日期" :formatter="dateFormat" sortable></el-table-column>
            <el-table-column prop="author" label="作者" ></el-table-column>
            <el-table-column prop="enabled" label="显隐" ></el-table-column>
...
export default {
  ...
  methods: {
    ...
    deleteBlog(index, row) {
      ...
      this.$axios.post(this.Global.serverhost + 'deleteBlogById',this.$qs.stringify(
          params
      )).then(res =>{
          console.log(res);
